								...
								if($type == "monitors")
									{
                        				...
                        				<label for="reply" class ="control-label">Reply</label>
                       					<div class="controls">
                            			<textarea name="reply" class="form-control" id = "reply" required="required"><?php echo $reply; ?></textarea>
...
<button type="button" class="btn btn-danger" data-toggle="collapse" data-target="#demo">Turn on / off block users</button>
      							<div id="demo" class="collapse in">
                                       ...
                                       <?php
											...
											echo '<td>';
											echo "<form method=\"post\" action=\"dashboard.php\"> <input type=\"hidden\" name= \"monitors_contact\" value=\"". $row["contactuid"] ."\"> <button type=\"submit\" class=\"btn btn-outline btn-success\" name=\"monitors_contact_reply\">Reply</button></form>";
											echo '</td>';
											echo '</tr>';
														}
												}
                                 ...
                                 <?php
								 //display complaints approval form
								 ?>
